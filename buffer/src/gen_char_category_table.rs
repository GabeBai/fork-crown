...
pub unsafe extern "C" fn fill(
    ...
    while (*alnum_0) != 0 {
        crate::src::gen_char_category_table::char_cat[(*alnum_0) as libc::c_uchar as usize]|= value;
        alnum_0= alnum_0.offset(1);
        alnum_0;
    }
    while (*special) != 0 {
        crate::src::gen_char_category_table::char_cat[(*special) as libc::c_uchar as usize]|= value;
...
pub unsafe extern "C" fn print_table() {
    ...
    let mut y = 0 as libc::c_int as libc::c_uint;
    while y < 16 as libc::c_int as libc::c_uint {
        ...
        while x < 16 as libc::c_int as libc::c_uint {
            ...
            printf(
                ...
                crate::src::gen_char_category_table::char_cat[offset as usize],
...
unsafe fn main_0() -> libc::c_int {
    fill(
        ...
        crate::src::gen_char_category_table::alnum,
        b"+-.\0" as *const u8 as *const libc::c_char,
    );
    fill(Unreserved as libc::c_int as libc::c_uint, crate::src::gen_char_category_table::alnum, crate::src::gen_char_category_table::unreserved);
    fill(
        GenDelim as libc::c_int as libc::c_uint,
        crate::src::gen_char_category_table::alnum,
        b":/?#[]@\0" as *const u8 as *const libc::c_char,
    );
    fill(SubDelim as libc::c_int as libc::c_uint, crate::src::gen_char_category_table::alnum, crate::src::gen_char_category_table::subdelim);
    fill(
        PCharSlash as libc::c_int as libc::c_uint,
        crate::src::gen_char_category_table::alnum,
        b":@/%\0" as *const u8 as *const libc::c_char,
    );
    fill(PCharSlash as libc::c_int as libc::c_uint, crate::src::gen_char_category_table::unreserved, crate::src::gen_char_category_table::subdelim);
    fill(
    ...
    fill(Query as libc::c_int as libc::c_uint, crate::src::gen_char_category_table::unreserved, crate::src::gen_char_category_table::subdelim);
    fill(
        Userinfo as libc::c_int as libc::c_uint,
        crate::src::gen_char_category_table::alnum,
        b":%\0" as *const u8 as *const libc::c_char,
    );
    fill(Userinfo as libc::c_int as libc::c_uint, crate::src::gen_char_category_table::unreserved, crate::src::gen_char_category_table::subdelim);
    fill(
