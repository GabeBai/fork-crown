...
pub struct _IO_FILE {
    ...
    pub _markers: *mut crate::src::osys::_IO_marker,
    ...
    pub _wide_data: *mut crate::src::osys::_IO_wide_data,
...
pub struct opng_process_struct {
    ...
    pub in_datastream_offset: osys_foffset_t,
    pub in_file_size: osys_fsize_t,
    pub out_file_size: osys_fsize_t,
    pub in_idat_size: osys_fsize_t,
    pub out_idat_size: osys_fsize_t,
    pub best_idat_size: osys_fsize_t,
    pub max_idat_size: osys_fsize_t,
...
pub type png_rw_ptr = Option::<
    unsafe extern "C" fn(png_structp, png_bytep, png_size_t) -> (),
>;
...
pub static mut the_exception_context: [exception_context; 1] = [exception_context {
    ...
    caught: 0,
    v: C2RustUnnamed {
        etmp: 0 as *const libc::c_char,
    },
}; 1];
static mut presets: [opng_preset; 8] = [
    {
        let mut init = opng_preset {
...
static mut filter_table: [libc::c_int; 6] = [
    0x8 as libc::c_int,
    0x10 as libc::c_int,
    0x20 as libc::c_int,
    0x40 as libc::c_int,
...
static mut idat_size_max: osys_fsize_t = 0x7fffffff as libc::c_long as png_uint_32
    as osys_fsize_t;
static mut idat_size_max_string: *const libc::c_char = b"2GB\0" as *const u8
...
unsafe extern "C" fn opng_print_fsize_ratio(
    mut num: osys_fsize_t,
    mut denom: osys_fsize_t,
) {
    let mut buffer: [libc::c_char; 32] = [0; 32];
    let mut ratio = opng_ulratio { num: 0, denom: 0 };
    let mut result: libc::c_int = 0;
    ratio.num = num;
    ratio.denom = denom;
    result = crate::src::ratio::opng_ulratio_to_factor_string(
        buffer.as_mut_ptr(),
...
unsafe extern "C" fn opng_print_fsize_difference(
    mut init_size: osys_fsize_t,
    mut final_size: osys_fsize_t,
    mut show_ratio: libc::c_int,
) {
    let mut difference: osys_fsize_t = 0;
    ...
    if difference == 0 as libc::c_int as osys_fsize_t {
        usr_printf
            .expect(
                "non-null function pointer",
    ...
    if difference == 1 as libc::c_int as osys_fsize_t {
        usr_printf
            .expect(
                "non-null function pointer",
    ...
    if show_ratio != 0 && init_size > 0 as libc::c_int as osys_fsize_t {
        usr_printf
            .expect(
                "non-null function pointer",
            )(b" = \0" as *const u8 as *const libc::c_char);
...
unsafe extern "C" fn opng_print_image_info(
    ...
    if show_depth != 0 {
        ...
        printed = 1 as libc::c_int;
        channels = type_channels[(image.color_type & 7 as libc::c_int) as usize];
        ...
        } else if image.bit_depth != 1 as libc::c_int {
            usr_printf
                .expect(
                    "non-null function pointer",
                )(
    ...
    if show_type != 0 {
        ...
        printed = 1 as libc::c_int;
        if image.color_type & 1 as libc::c_int != 0 {
            if image.num_palette == 1 as libc::c_int {
                usr_printf
                    .expect(
                        "non-null function pointer",
            ...
            if image.num_trans > 0 as libc::c_int {
                usr_printf
                    .expect(
                        "non-null function pointer",
                    )(
            ...
            }else { std::intrinsics::assume((image.trans_color_ptr).addr() == 0); }
        }
    }
    if show_interlaced != 0 {
        if image.interlace_type != 0 as libc::c_int {
            if printed != 0 {
                usr_printf
                    .expect(
                        "non-null function pointer",
...
unsafe extern "C" fn opng_error(mut png_ptr: png_structp, mut msg: png_const_charp) {
    ...
    loop {
        ...
        ::core::ptr::write_volatile(fresh0, msg);
        longjmp(
...
unsafe extern "C" fn opng_check_idat_size(mut size: osys_fsize_t) {
...
unsafe extern "C" fn opng_is_image_chunk(mut chunk_type: png_bytep) -> libc::c_int {
    ...
    if memcmp(
        chunk_type as *const libc::c_void,
        sig_tRNS.as_ptr() as *const libc::c_void,
        4 as libc::c_int as libc::c_ulong,
    ) == 0 as libc::c_int
    {
        return 1 as libc::c_int;
...
unsafe extern "C" fn opng_is_apng_chunk(mut chunk_type: png_bytep) -> libc::c_int {
    if memcmp(
        chunk_type as *const libc::c_void,
        sig_acTL.as_ptr() as *const libc::c_void,
        4 as libc::c_int as libc::c_ulong,
    ) == 0 as libc::c_int
        || memcmp(
            chunk_type as *const libc::c_void,
            sig_fcTL.as_ptr() as *const libc::c_void,
            4 as libc::c_int as libc::c_ulong,
        ) == 0 as libc::c_int
        || memcmp(
            chunk_type as *const libc::c_void,
            sig_fdAT.as_ptr() as *const libc::c_void,
            4 as libc::c_int as libc::c_ulong,
        ) == 0 as libc::c_int
    {
        return 1 as libc::c_int;
...
unsafe extern "C" fn opng_allow_chunk(mut chunk_type: png_bytep) -> libc::c_int {
    ...
    if memcmp(
        chunk_type as *const libc::c_void,
        sig_dSIG.as_ptr() as *const libc::c_void,
        4 as libc::c_int as libc::c_ulong,
    ) == 0 as libc::c_int
    {
        return 0 as libc::c_int;
...
unsafe extern "C" fn opng_handle_chunk(
    ...
    if memcmp(
        chunk_type as *const libc::c_void,
        sig_bKGD.as_ptr() as *const libc::c_void,
        4 as libc::c_int as libc::c_ulong,
    ) == 0 as libc::c_int
        || memcmp(
            chunk_type as *const libc::c_void,
            sig_hIST.as_ptr() as *const libc::c_void,
            4 as libc::c_int as libc::c_ulong,
        ) == 0 as libc::c_int
        || memcmp(
            chunk_type as *const libc::c_void,
            sig_sBIT.as_ptr() as *const libc::c_void,
            4 as libc::c_int as libc::c_ulong,
        ) == 0 as libc::c_int
    {
        return;
    ...
    {
        process.status |= INPUT_HAS_DIGITAL_SIGNATURE as libc::c_int as libc::c_uint;
    } else if opng_is_apng_chunk(chunk_type) != 0 {
        process.status |= INPUT_HAS_APNG as libc::c_int as libc::c_uint;
        if memcmp(
            chunk_type as *const libc::c_void,
            sig_fdAT.as_ptr() as *const libc::c_void,
            4 as libc::c_int as libc::c_ulong,
        ...
        {
            process.status |= INPUT_HAS_MULTIPLE_IMAGES as libc::c_int as libc::c_uint;
        }
        if options.snip != 0 {
            process.status |= INPUT_HAS_JUNK as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn opng_init_write_data() {
    process.out_file_size = 0 as libc::c_int as osys_fsize_t;
    process.out_plte_trns_size = 0 as libc::c_int as png_uint_32;
    process.out_idat_size = 0 as libc::c_int as osys_fsize_t;
}
unsafe extern "C" fn opng_read_data(
    ...
    let mut stream = png_get_io_ptr(png_ptr as *const png_struct) as *mut FILE;
    let mut io_state = png_get_io_state(png_ptr as *const png_struct) as libc::c_int;
    let mut io_state_loc = io_state & 0xf0 as libc::c_int;
    let mut chunk_sig = 0 as *mut png_byte;
    if fread(
    ...
    if process.in_file_size == 0 as libc::c_int as osys_fsize_t {
        ...
        process
            .in_datastream_offset = crate::src::osys::osys_ftello(stream)
            - 8 as libc::c_int as osys_foffset_t;
        process.status |= INPUT_HAS_PNG_DATASTREAM as libc::c_int as libc::c_uint;
        if io_state_loc == 0x10 as libc::c_int {
            process.status |= INPUT_HAS_PNG_SIGNATURE as libc::c_int as libc::c_uint;
        }
        if process.in_datastream_offset == 0 as libc::c_int as osys_foffset_t {
            process.status |= INPUT_IS_PNG_FILE as libc::c_int as libc::c_uint;
        } else if process.in_datastream_offset < 0 as libc::c_int as osys_foffset_t {
            png_error(
                png_ptr as *const png_struct,
    ...
    process
        .in_file_size = (process.in_file_size as libc::c_ulong).wrapping_add(length)
        as osys_fsize_t as osys_fsize_t;
    ...
    if io_state_loc == 0x20 as libc::c_int {
        ...
        if memcmp(
            ...
            sig_IDAT.as_ptr() as *const libc::c_void,
            4 as libc::c_int as libc::c_ulong,
        ) == 0 as libc::c_int
        {
            if !(png_ptr == read_ptr) {
            ...
            if (png_get_rows(
                read_ptr as *const png_struct,
                read_info_ptr as *const png_info,
            ))
                .is_null()
            {std::intrinsics::assume((png_get_rows(read_ptr as *const png_struct, read_info_ptr as *const png_info)).addr() == 0);
                if !(process.in_idat_size == 0 as libc::c_int as osys_fsize_t) {
                    usr_panic
                        .expect(
                            "non-null function pointer",
                        )(
                ...
                if (pngx_malloc_rows(read_ptr, read_info_ptr, 0 as libc::c_int))
                    .is_null()
                {std::intrinsics::assume((pngx_malloc_rows(read_ptr, read_info_ptr, 0 as libc::c_int)).addr() == 0);
                    usr_panic
                        .expect(
                            "non-null function pointer",
                        )(
                ...
                png_data_freer(
                    ...
                    read_info_ptr,
                    2 as libc::c_int,
                    0x40 as libc::c_int as png_uint_32,
                );
            } else {
                process.status |= INPUT_HAS_JUNK as libc::c_int as libc::c_uint;
            }
            process
                .in_idat_size = (process.in_idat_size)
                .wrapping_add(
            ...
            chunk_sig as *const libc::c_void,
            sig_PLTE.as_ptr() as *const libc::c_void,
            4 as libc::c_int as libc::c_ulong,
        ) == 0 as libc::c_int
            || memcmp(
                chunk_sig as *const libc::c_void,
        ...
        {
            process
                .in_plte_trns_size = (process.in_plte_trns_size)
                .wrapping_add(
                    ((*data as png_uint_32) << 24 as libc::c_int)
                        .wrapping_add(
                            (*data.offset(1 as libc::c_int as isize) as png_uint_32)
...
unsafe extern "C" fn opng_write_data(
    ...
    static mut crt_idat_offset: osys_foffset_t = 0;
    static mut crt_idat_size: osys_fsize_t = 0;
    ...
    if io_state_loc == 0x20 as libc::c_int {
        ...
        ) == 0 as libc::c_int
        {
            ...
            process
                .out_idat_size = (process.out_idat_size)
                .wrapping_add(
                    ((*data as png_uint_32) << 24 as libc::c_int)
                        .wrapping_add(
                            (*data.offset(1 as libc::c_int as isize) as png_uint_32)
            ...
            if stream.is_null() {std::intrinsics::assume((stream).addr() == 0);
                if process.out_idat_size > process.max_idat_size {
                    loop {
                        let ref mut fresh2 = (*the_exception_context.as_mut_ptr())
                            .v
                            .etmp;
                        ::core::ptr::write_volatile(fresh2, 0 as *const libc::c_char);
                        longjmp(
                            (*(*the_exception_context.as_mut_ptr()).penv).as_mut_ptr(),
                            1 as libc::c_int,
                        );
            ...
            {
                process
                    .out_plte_trns_size = (process.out_plte_trns_size)
                    .wrapping_add(
                        ((*data as png_uint_32) << 24 as libc::c_int)
                            .wrapping_add(
                                (*data.offset(1 as libc::c_int as isize) as png_uint_32)
    ...
    match io_state_loc {
        32 => {
            if crt_chunk_is_idat != 0 {
                if crt_idat_offset == 0 as libc::c_int as osys_foffset_t {
                    crt_idat_offset = crate::src::osys::osys_ftello(stream);
                    if process.best_idat_size > 0 as libc::c_int as osys_fsize_t {
            ...
            } else if crt_idat_offset != 0 as libc::c_int as osys_foffset_t {
                ...
                process
                    .out_file_size = (process.out_file_size)
                    .wrapping_add(4 as libc::c_int as osys_fsize_t);
                if process.out_idat_size != crt_idat_size {
                    ...
                    if crate::src::osys::osys_fwrite_at(
                        stream,
                        crt_idat_offset,
                        0 as libc::c_int,
                        buf.as_mut_ptr() as *const libc::c_void,
                ...
                crt_idat_offset = 0 as libc::c_int as osys_foffset_t;
            }
        }
        64 => {
            if crt_chunk_is_idat != 0 {
    ...
    process
        .out_file_size = (process.out_file_size as libc::c_ulong).wrapping_add(length)
        as osys_fsize_t as osys_fsize_t;
}
unsafe extern "C" fn opng_clear_image_info() {
    memset(
        &raw mut image as *mut opng_image_struct as *mut libc::c_void,
        0 as libc::c_int,
...
unsafe extern "C" fn opng_load_image_info(
    ...
    ) != 0
    {
        if !(image.trans_color_ptr).is_null() {
            ...
            image.trans_color_ptr = &raw mut image.trans_color;
        }else { std::intrinsics::assume((image.trans_color_ptr).addr() == 0); }
    }
    if load_meta == 0 {
        return;
    }
    if png_get_bKGD(png_ptr as *const png_struct, info_ptr, &raw mut image.background_ptr)
        != 0
    {
        image.background = *image.background_ptr;
        image.background_ptr = &raw mut image.background;
    }
    png_get_hIST(png_ptr as *const png_struct, info_ptr, &raw mut image.hist);
    if png_get_sBIT(png_ptr as *const png_struct, info_ptr, &raw mut image.sig_bit_ptr) != 0
    {
        image.sig_bit = *image.sig_bit_ptr;
        image.sig_bit_ptr = &raw mut image.sig_bit;
    }
    image
...
unsafe extern "C" fn opng_store_image_info(
    ...
    if (image.row_pointers).is_null() {std::intrinsics::assume((image.row_pointers).addr() == 0);
        usr_panic
            .expect(
                "non-null function pointer",
    ...
    png_set_rows(write_ptr as *const png_struct, write_info_ptr, image.row_pointers);
    ...
    }else { std::intrinsics::assume((image.palette).addr() == 0); }
    ...
    }else { std::intrinsics::assume((image.background_ptr).addr() == 0); }
    ...
    }else { std::intrinsics::assume((image.hist).addr() == 0); }
    ...
    }else { std::intrinsics::assume((image.sig_bit_ptr).addr() == 0); }
    if image.num_unknowns != 0 as libc::c_int {
        ...
        while i < image.num_unknowns {
            png_set_unknown_chunk_location(
                ...
                info_ptr,
                i,
                (*(image.unknowns).offset(i as isize)).location as libc::c_int,
            );
            i += 1;
            i;
        }
...
unsafe extern "C" fn opng_read_file(mut infile: *mut FILE) {
    ...
    ::core::ptr::write_volatile(
        &raw mut exception__prev as *mut *mut jmp_buf,
        (*the_exception_context.as_mut_ptr()).penv,
    );
    (*the_exception_context.as_mut_ptr()).penv = &raw mut exception__env;
    if _setjmp(exception__env.as_mut_ptr()) == 0 as libc::c_int {
        loop {
            read_ptr = png_create_read_struct(
                b"1.6.21\0" as *const u8 as *const libc::c_char,
            ...
            read_info_ptr = png_create_info_struct(read_ptr as *const png_struct);
            if read_info_ptr.is_null() {std::intrinsics::assume((read_info_ptr).addr() == 0);
                loop {
                    let ref mut fresh4 = (*the_exception_context.as_mut_ptr()).v.etmp;
                    ::core::ptr::write_volatile(
                        fresh4,
            ...
            if num_img <= 0 as libc::c_int {
                loop {
                    let ref mut fresh5 = (*the_exception_context.as_mut_ptr()).v.etmp;
                    ::core::ptr::write_volatile(
                        fresh5,
            ...
            if process.status & INPUT_IS_PNG_FILE as libc::c_int as libc::c_uint != 0
                && process.status
            ...
            if fmt_name.is_null() {std::intrinsics::assume((fmt_name).addr() == 0);
                usr_panic
                    .expect(
                        "non-null function pointer",
                    )(
            ...
            if process.in_file_size == 0 as libc::c_int as osys_fsize_t {
                if crate::src::osys::osys_fgetsize(infile, &raw mut process.in_file_size) < 0 as libc::c_int {
                    opng_print_warning(
                        b"Can't get the correct file size\0" as *const u8
                            as *const libc::c_char,
                    );
                    process.in_file_size = 0 as libc::c_int as osys_fsize_t;
                }
            }
            ::core::ptr::write_volatile(
                &raw mut err_msg as *mut *const libc::c_char,
    ...
    (*the_exception_context.as_mut_ptr()).penv = exception__prev;
    if !((*the_exception_context.as_mut_ptr()).caught == 0
        || {
            ::core::ptr::write_volatile(
                &raw mut err_msg as *mut *const libc::c_char,
    ...
    let mut exception__prev_0 = 0 as *mut jmp_buf;
    ...
    ::core::ptr::write_volatile(
        &raw mut exception__prev_0 as *mut *mut jmp_buf,
        (*the_exception_context.as_mut_ptr()).penv,
    );
    (*the_exception_context.as_mut_ptr()).penv = &raw mut exception__env_0;
    if _setjmp(exception__env_0.as_mut_ptr()) == 0 as libc::c_int {
        loop {
            if !err_msg.is_null() {
                loop {
                    let ref mut fresh8 = (*the_exception_context.as_mut_ptr()).v.etmp;
                    ::core::ptr::write_volatile(fresh8, err_msg);
                    longjmp(
                        (*(*the_exception_context.as_mut_ptr()).penv).as_mut_ptr(),
                        1 as libc::c_int,
                    );
                }
            }else { std::intrinsics::assume((err_msg).addr() == 0); }
                ...
                != 0 as libc::c_int
            {
                ...
                if process.status
                    & INPUT_HAS_MULTIPLE_IMAGES as libc::c_int as libc::c_uint != 0
                {
                    if process.status & INPUT_IS_PNG_FILE as libc::c_int as libc::c_uint
                        == 0
                    {
                        usr_printf
                            .expect(
            ...
            opng_load_image_info(read_ptr, read_info_ptr, 1 as libc::c_int);
            ...
            if process.status & INPUT_IS_PNG_FILE as libc::c_int as libc::c_uint != 0
                && process.status
                    & INPUT_HAS_MULTIPLE_IMAGES as libc::c_int as libc::c_uint != 0
                && reductions != 0 as libc::c_int as png_uint_32 && options.snip == 0
            {
                usr_printf
                    .expect(
                        "non-null function pointer",
            ...
            if process.reductions != 0 as libc::c_int as png_uint_32 {
                opng_load_image_info(read_ptr, read_info_ptr, 1 as libc::c_int);
                usr_printf
                    .expect(
                        "non-null function pointer",
            ...
            {
                image.interlace_type = options.interlace;
                process.status |= OUTPUT_NEEDS_NEW_IDAT as libc::c_int as libc::c_uint;
            }
            (*the_exception_context.as_mut_ptr()).caught = 0 as libc::c_int;
            if !((*the_exception_context.as_mut_ptr()).caught != 0) {
                break;
    ...
    (*the_exception_context.as_mut_ptr()).penv = exception__prev_0;
    if (*the_exception_context.as_mut_ptr()).caught == 0
        || {
            ::core::ptr::write_volatile(
                &raw mut err_msg as *mut *const libc::c_char,
    ...
    {} else {
        png_data_freer(
            ...
            read_info_ptr,
            1 as libc::c_int,
            0x7fff as libc::c_int as png_uint_32,
        );
        png_destroy_read_struct(&raw mut read_ptr, &raw mut read_info_ptr, 0 as png_infopp);
        loop {
            let ref mut fresh10 = (*the_exception_context.as_mut_ptr()).v.etmp;
            ::core::ptr::write_volatile(fresh10, err_msg);
            longjmp(
                (*(*the_exception_context.as_mut_ptr()).penv).as_mut_ptr(),
                1 as libc::c_int,
            );
...
unsafe extern "C" fn opng_write_file(
    ...
    if _setjmp(exception__env.as_mut_ptr()) == 0 as libc::c_int {
        loop {
            ...
            write_info_ptr = png_create_info_struct(write_ptr as *const png_struct);
            if write_info_ptr.is_null() {std::intrinsics::assume((write_info_ptr).addr() == 0);
                loop {
                    let ref mut fresh12 = (*the_exception_context.as_mut_ptr()).v.etmp;
                    ::core::ptr::write_volatile(
                        fresh12,
                        b"Out of memory\0" as *const u8 as *const libc::c_char,
                    );
            ...
            png_set_filter(write_ptr, 0 as libc::c_int, filter_table[filter as usize]);
                ...
                && compression_strategy != 3 as libc::c_int
            {
                ...
                png_set_compression_window_bits(write_ptr, 9 as libc::c_int);
            }
            png_set_keep_unknown_chunks(
                write_ptr,
                3 as libc::c_int,
    ...
    {
        process
            .out_idat_size = idat_size_max
            .wrapping_add(1 as libc::c_int as osys_fsize_t);
    }
    png_destroy_write_struct(&raw mut write_ptr, &raw mut write_info_ptr);
    if !err_msg.is_null() {
        loop {
            let ref mut fresh14 = (*the_exception_context.as_mut_ptr()).v.etmp;
            ::core::ptr::write_volatile(fresh14, err_msg);
            longjmp(
                (*(*the_exception_context.as_mut_ptr()).penv).as_mut_ptr(),
                1 as libc::c_int,
            );
...
unsafe extern "C" fn opng_copy_file(mut infile: *mut FILE, mut outfile: *mut FILE) {
    let mut buf = 0 as *mut png_byte;
    let buf_size_incr = 0x1000 as libc::c_int as png_uint_32;
    ...
    if write_ptr.is_null() {std::intrinsics::assume((write_ptr).addr() == 0);
        loop {
            let ref mut fresh15 = (*the_exception_context.as_mut_ptr()).v.etmp;
            ::core::ptr::write_volatile(
                fresh15,
                b"Out of memory\0" as *const u8 as *const libc::c_char,
            );
    ...
    if _setjmp(exception__env.as_mut_ptr()) == 0 as libc::c_int {
        loop {
            ::core::ptr::write_volatile(&raw mut buf as *mut png_bytep, 0 as png_bytep);
            ...
            loop {
                ...
                {
                    loop {
                        let ref mut fresh17 = (*the_exception_context.as_mut_ptr())
                            .v
                            .etmp;
                        ::core::ptr::write_volatile(
                            fresh17,
                ...
                if length > 0x7fffffff as libc::c_long as png_uint_32 {
                    ...
                    {
                        loop {
                            let ref mut fresh18 = (*the_exception_context.as_mut_ptr())
                                .v
                                .etmp;
                            ::core::ptr::write_volatile(
                                fresh18,
                    ...
                    if length.wrapping_add(4 as libc::c_int as png_uint_32) > buf_size {
                        ...
                        ::core::ptr::write_volatile(
                            &raw mut buf as *mut png_bytep,
                            png_malloc(
                                write_ptr as *const png_struct,
                    ...
                    {
                        loop {
                            let ref mut fresh19 = (*the_exception_context.as_mut_ptr())
                                .v
                                .etmp;
                            ::core::ptr::write_volatile(
                                fresh19,
                ...
                if !(memcmp(
                    ...
                    sig_IEND.as_ptr() as *const libc::c_void,
                    4 as libc::c_int as libc::c_ulong,
                ) != 0 as libc::c_int)
                {
                    break;
    ...
    png_free(write_ptr as *const png_struct, buf as png_voidp);
    png_destroy_write_struct(&raw mut write_ptr, 0 as png_infopp);
    if !err_msg.is_null() {
        loop {
            let ref mut fresh21 = (*the_exception_context.as_mut_ptr()).v.etmp;
            ::core::ptr::write_volatile(fresh21, err_msg);
            longjmp(
                (*(*the_exception_context.as_mut_ptr()).penv).as_mut_ptr(),
                1 as libc::c_int,
            );
...
unsafe extern "C" fn opng_init_iteration(
    ...
    *output_set = cmdline_set & mask_set;
    ...
    {
        loop {
            let ref mut fresh22 = (*the_exception_context.as_mut_ptr()).v.etmp;
            ::core::ptr::write_volatile(
                fresh22,
                b"Iteration parameter(s) out of range\0" as *const u8
                    as *const libc::c_char,
            );
            longjmp(
                (*(*the_exception_context.as_mut_ptr()).penv).as_mut_ptr(),
    ...
    if *output_set == 0 as libc::c_int as opng_bitset_t
        || options.optim_level >= 0 as libc::c_int
    {
        preset_set = crate::src::bitset::opng_rangeset_string_to_bitset(preset, 0 as *mut size_t);
...
unsafe extern "C" fn opng_init_iterations() {
    ...
    if process.status & OUTPUT_NEEDS_NEW_IDAT as libc::c_int as libc::c_uint != 0
        || options.full != 0
    {
        ...
        process
            .max_idat_size = (process.in_idat_size)
            .wrapping_add(process.in_plte_trns_size as osys_fsize_t);
    }
    ...
    if image.bit_depth < 8 as libc::c_int || !(image.palette).is_null() {
    ...
    t1 = (crate::src::bitset::opng_bitset_count(compr_level_set))
        .wrapping_mul(crate::src::bitset::opng_bitset_count(strategy_set & !strategy_singles_set))
        as libc::c_int;
    t2 = crate::src::bitset::opng_bitset_count(strategy_set & strategy_singles_set) as libc::c_int;
    process
        .num_iterations = ((t1 + t2) as libc::c_uint)
        .wrapping_mul(crate::src::bitset::opng_bitset_count(mem_level_set))
        .wrapping_mul(crate::src::bitset::opng_bitset_count(filter_set)) as libc::c_int;
    if !(process.num_iterations > 0 as libc::c_int) {
        usr_panic
            .expect(
                "non-null function pointer",
...
unsafe extern "C" fn opng_iterate() {
    ...
    let mut strategy_set: opng_bitset_t = 0;
    let mut filter_set: opng_bitset_t = 0;
    let mut saved_compr_level_set: opng_bitset_t = 0;
    ...
    if process.num_iterations == 1 as libc::c_int
        && process.status & OUTPUT_NEEDS_NEW_IDAT as libc::c_int as libc::c_uint != 0
    {
        process.best_idat_size = 0 as libc::c_int as osys_fsize_t;
        process.best_compr_level = crate::src::bitset::opng_bitset_find_first(process.compr_level_set);
        process.best_mem_level = crate::src::bitset::opng_bitset_find_first(process.mem_level_set);
        process.best_strategy = crate::src::bitset::opng_bitset_find_first(process.strategy_set);
        process.best_filter = crate::src::bitset::opng_bitset_find_first(process.filter_set);
        return;
    }
    ...
    process
        .best_idat_size = idat_size_max.wrapping_add(1 as libc::c_int as osys_fsize_t);
    process.best_compr_level = -(1 as libc::c_int);
    process.best_mem_level = -(1 as libc::c_int);
    process.best_strategy = -(1 as libc::c_int);
    process.best_filter = -(1 as libc::c_int);
    usr_printf
        .expect(
            "non-null function pointer",
        )(b"\nTrying:\n\0" as *const u8 as *const libc::c_char);
                            ...
                            while mem_level >= 1 as libc::c_int {
                                    ...
                                    != 0 as libc::c_int as libc::c_uint
                                {
                                    ...
                                    usr_progress
                                        ...
                                        process.num_iterations as libc::c_ulong,
                                    );
                                    counter += 1;
                                    counter;
                                    opng_write_file(
                                    ...
                                    if process.out_idat_size > idat_size_max {
                                        ...
                                        if !(process.best_idat_size < process.out_idat_size) {
                                            if !(process.best_idat_size == process.out_idat_size
                                                && process.best_strategy >= 2 as libc::c_int)
                                            {
    ...
    usr_progress
        .expect(
            "non-null function pointer",
        )(counter as libc::c_ulong, process.num_iterations as libc::c_ulong);
}
unsafe extern "C" fn opng_finish_iterations() {
    if (process.best_idat_size).wrapping_add(process.out_plte_trns_size as osys_fsize_t)
        < (process.in_idat_size).wrapping_add(process.in_plte_trns_size as osys_fsize_t)
    {
        process.status |= OUTPUT_NEEDS_NEW_IDAT as libc::c_int as libc::c_uint;
    }
    if process.status & OUTPUT_NEEDS_NEW_IDAT as libc::c_int as libc::c_uint != 0 {
...
unsafe extern "C" fn opng_optimize_impl(mut infile_name: *const libc::c_char) {
    ...
    let mut err_msg = 0 as *const libc::c_char;
    memset(
        &raw mut process as *mut opng_process_struct as *mut libc::c_void,
        0 as libc::c_int,
    ...
    if infile.is_null() {std::intrinsics::assume((infile).addr() == 0);
        loop {
            let ref mut fresh23 = (*the_exception_context.as_mut_ptr()).v.etmp;
            ::core::ptr::write_volatile(
                fresh23,
    ...
    {
        if err_msg.is_null() {std::intrinsics::assume((err_msg).addr() == 0);
            usr_panic
                .expect(
                    "non-null function pointer",
                )(
                b"Mysterious error in opng_read_file\0" as *const u8
                    as *const libc::c_char,
            );
        }
    }
    ...
    if !err_msg.is_null() {
        loop {
            let ref mut fresh26 = (*the_exception_context.as_mut_ptr()).v.etmp;
            ::core::ptr::write_volatile(fresh26, err_msg);
            longjmp(
                (*(*the_exception_context.as_mut_ptr()).penv).as_mut_ptr(),
                1 as libc::c_int,
            );
    ...
    if process.status & INPUT_HAS_ERRORS as libc::c_int as libc::c_uint != 0 {
        usr_printf
            .expect(
                "non-null function pointer",
            )(
        ...
        if options.fix != 0 {
            ...
            process.status |= OUTPUT_NEEDS_NEW_FILE as libc::c_int as libc::c_uint;
        } else {
            usr_printf
                .expect(
                    "non-null function pointer",
            ...
            loop {
                let ref mut fresh27 = (*the_exception_context.as_mut_ptr()).v.etmp;
                ::core::ptr::write_volatile(
                    fresh27,
    ...
    if process.status & INPUT_HAS_JUNK as libc::c_int as libc::c_uint != 0 {
        process.status |= OUTPUT_NEEDS_NEW_FILE as libc::c_int as libc::c_uint;
    }
    if process.status & INPUT_HAS_PNG_SIGNATURE as libc::c_int as libc::c_uint == 0 {
        process.status |= OUTPUT_NEEDS_NEW_FILE as libc::c_int as libc::c_uint;
    }
    if process.status & INPUT_HAS_PNG_DATASTREAM as libc::c_int as libc::c_uint != 0 {
        if options.nz != 0
            && process.status & OUTPUT_NEEDS_NEW_IDAT as libc::c_int as libc::c_uint != 0
        {
            usr_printf
            ...
            loop {
                let ref mut fresh28 = (*the_exception_context.as_mut_ptr()).v.etmp;
                ::core::ptr::write_volatile(
                    fresh28,
                    b"Can't continue\0" as *const u8 as *const libc::c_char,
                );
                longjmp(
                    (*(*the_exception_context.as_mut_ptr()).penv).as_mut_ptr(),
                    1 as libc::c_int,
    ...
    if process.status & INPUT_HAS_DIGITAL_SIGNATURE as libc::c_int as libc::c_uint != 0 {
        usr_printf
            .expect(
                "non-null function pointer",
            )(
        ...
        if options.force != 0 {
            ...
            loop {
                let ref mut fresh29 = (*the_exception_context.as_mut_ptr()).v.etmp;
                ::core::ptr::write_volatile(
                    fresh29,
    ...
    if process.status & INPUT_HAS_MULTIPLE_IMAGES as libc::c_int as libc::c_uint != 0 {
        if options.snip == 0
            && process.status & INPUT_IS_PNG_FILE as libc::c_int as libc::c_uint == 0
        {
            usr_printf
                .expect(
                    "non-null function pointer",
            ...
            loop {
                let ref mut fresh30 = (*the_exception_context.as_mut_ptr()).v.etmp;
                ::core::ptr::write_volatile(
                    fresh30,
    ...
    if process.status & INPUT_HAS_APNG as libc::c_int as libc::c_uint != 0
        && options.snip != 0
    {
        process.status |= OUTPUT_NEEDS_NEW_FILE as libc::c_int as libc::c_uint;
    }
    if process.status & INPUT_HAS_STRIPPED_DATA as libc::c_int as libc::c_uint != 0 {
        usr_printf
            .expect(
                "non-null function pointer",
    ...
    if process.status & INPUT_IS_PNG_FILE as libc::c_int as libc::c_uint == 0 {
        if (crate::src::osys::osys_path_chext(
            name_buf.as_mut_ptr(),
            ...
            .is_null()
        {std::intrinsics::assume((crate::src::osys::osys_path_chext(name_buf.as_mut_ptr(),
    ::core::mem::size_of::<[libc::c_char; 4096]>() as libc::c_ulong,
    infile_name_local, b".png\x00" as *const u8 as *const libc::c_char)).addr() == 0);
            loop {
                let ref mut fresh31 = (*the_exception_context.as_mut_ptr()).v.etmp;
                ::core::ptr::write_volatile(
                    fresh31,
    ...
    }else { std::intrinsics::assume((options.out_name).addr() == 0); }
    if !(options.dir_name).is_null() {
        let mut tmp_name = 0 as *const libc::c_char;
        if !outfile_name.is_null() {
            strcpy(tmp_buf.as_mut_ptr(), outfile_name);
            tmp_name = tmp_buf.as_mut_ptr();
        } else {std::intrinsics::assume((outfile_name).addr() == 0);
            tmp_name = infile_name_local;
        }
        if (crate::src::osys::osys_path_chdir(
            name_buf.as_mut_ptr(),
            ::core::mem::size_of::<[libc::c_char; 4096]>() as libc::c_ulong,
            tmp_name,
            options.dir_name,
            ...
            .is_null()
        {std::intrinsics::assume((crate::src::osys::osys_path_chdir(name_buf.as_mut_ptr(),
    ::core::mem::size_of::<[libc::c_char; 4096]>() as libc::c_ulong, tmp_name,
    options.dir_name)).addr() == 0);
            loop {
                let ref mut fresh32 = (*the_exception_context.as_mut_ptr()).v.etmp;
                ::core::ptr::write_volatile(
                    fresh32,
                    b"Can't create the output file (name too long)\0" as *const u8
                        as *const libc::c_char,
        ...
        outfile_name = name_buf.as_mut_ptr();
    }else { std::intrinsics::assume((options.dir_name).addr() == 0); }
    if outfile_name.is_null() {std::intrinsics::assume((outfile_name).addr() == 0);
        outfile_name = infile_name_local;
        new_outfile = 0 as libc::c_int;
    } else {
        let mut test_eq = crate::src::osys::osys_test_eq(infile_name_local, outfile_name);
    ...
    if new_outfile != 0 {
        if (crate::src::osys::osys_path_mkbak(
            tmp_buf.as_mut_ptr(),
            ::core::mem::size_of::<[libc::c_char; 4096]>() as libc::c_ulong,
            outfile_name,
        ))
            .is_null()
        {std::intrinsics::assume((crate::src::osys::osys_path_mkbak(tmp_buf.as_mut_ptr(),
    ::core::mem::size_of::<[libc::c_char; 4096]>() as libc::c_ulong,
    outfile_name)).addr() == 0);
            bakfile_name = 0 as *const libc::c_char;
        }
    } else if (crate::src::osys::osys_path_mkbak(
        tmp_buf.as_mut_ptr(),
        ::core::mem::size_of::<[libc::c_char; 4096]>() as libc::c_ulong,
        infile_name_local,
    ))
    ...
    {std::intrinsics::assume((crate::src::osys::osys_path_mkbak(tmp_buf.as_mut_ptr(),
    ::core::mem::size_of::<[libc::c_char; 4096]>() as libc::c_ulong,
    infile_name_local)).addr() == 0);
        bakfile_name = 0 as *const libc::c_char;
    }
    if bakfile_name.is_null() {std::intrinsics::assume((bakfile_name).addr() == 0);
        loop {
            let ref mut fresh33 = (*the_exception_context.as_mut_ptr()).v.etmp;
            ::core::ptr::write_volatile(
                fresh33,
    ...
    if options.simulate == 0
        && crate::src::osys::osys_test(outfile_name, b"e\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
    {
        if new_outfile != 0 && options.backup == 0 && options.clobber == 0 {
            ...
            loop {
                let ref mut fresh34 = (*the_exception_context.as_mut_ptr()).v.etmp;
                ::core::ptr::write_volatile(
                    fresh34,
                    b"Can't overwrite the output file\0" as *const u8
                        as *const libc::c_char,
                );
                longjmp(
                    (*(*the_exception_context.as_mut_ptr()).penv).as_mut_ptr(),
        ...
        if crate::src::osys::osys_test(outfile_name, b"fw\0" as *const u8 as *const libc::c_char)
            != 0 as libc::c_int
            || options.clobber == 0
                && crate::src::osys::osys_test(bakfile_name, b"e\0" as *const u8 as *const libc::c_char)
                    == 0 as libc::c_int
        {
            loop {
                let ref mut fresh35 = (*the_exception_context.as_mut_ptr()).v.etmp;
                ::core::ptr::write_volatile(
                    fresh35,
    ...
    if process.status & OUTPUT_NEEDS_NEW_FILE as libc::c_int as libc::c_uint == 0 {
        usr_printf
            .expect(
                "non-null function pointer",
            )(
    ...
    if new_outfile != 0 {
        ...
        if !(options.dir_name).is_null() {
            crate::src::osys::osys_create_dir(options.dir_name);
        }else { std::intrinsics::assume((options.dir_name).addr() == 0); }
        has_backup = 0 as libc::c_int;
        if crate::src::osys::osys_test(outfile_name, b"e\0" as *const u8 as *const libc::c_char)
            == 0 as libc::c_int
        {
            if crate::src::osys::osys_rename(outfile_name, bakfile_name, options.clobber)
                != 0 as libc::c_int
            {
                loop {
                    let ref mut fresh36 = (*the_exception_context.as_mut_ptr()).v.etmp;
                    ::core::ptr::write_volatile(
                        fresh36,
        ...
        if crate::src::osys::osys_rename(infile_name_local, bakfile_name, options.clobber)
            != 0 as libc::c_int
        {
            loop {
                let ref mut fresh37 = (*the_exception_context.as_mut_ptr()).v.etmp;
                ::core::ptr::write_volatile(
                    fresh37,
    ...
    if _setjmp(exception__env_0.as_mut_ptr()) == 0 as libc::c_int {
        loop {
            if outfile.is_null() {std::intrinsics::assume((outfile).addr() == 0);
                loop {
                    let ref mut fresh39 = (*the_exception_context.as_mut_ptr()).v.etmp;
                    ::core::ptr::write_volatile(
                        fresh39,
                        b"Can't open the output file\0" as *const u8
                            as *const libc::c_char,
                    );
                    longjmp(
                        (*(*the_exception_context.as_mut_ptr()).penv).as_mut_ptr(),
            ...
            if process.status & OUTPUT_NEEDS_NEW_IDAT as libc::c_int as libc::c_uint != 0
            {
                ...
                if infile.is_null() {std::intrinsics::assume((infile).addr() == 0);
                    loop {
                        let ref mut fresh40 = (*the_exception_context.as_mut_ptr())
                            .v
                            .etmp;
                        ::core::ptr::write_volatile(
                            fresh40,
                ...
                let mut exception__prev_1 = 0 as *mut jmp_buf;
                ...
                ::core::ptr::write_volatile(
                    &raw mut exception__prev_1 as *mut *mut jmp_buf,
                    (*the_exception_context.as_mut_ptr()).penv,
                );
                (*the_exception_context.as_mut_ptr()).penv = &raw mut exception__env_1;
                if _setjmp(exception__env_1.as_mut_ptr()) == 0 as libc::c_int {
                    loop {
                        if process.in_datastream_offset
                            > 0 as libc::c_int as osys_foffset_t
                            && crate::src::osys::osys_fseeko(
                                infile,
                        ...
                        {
                            loop {
                                let ref mut fresh42 = (*the_exception_context.as_mut_ptr())
                                    .v
                                    .etmp;
                                ::core::ptr::write_volatile(
                                    fresh42,
                ...
                (*the_exception_context.as_mut_ptr()).penv = exception__prev_1;
                if !((*the_exception_context.as_mut_ptr()).caught == 0
                    || {
                        ::core::ptr::write_volatile(
                            &raw mut err_msg as *mut *const libc::c_char,
                ...
                if !err_msg.is_null() {
                    loop {
                        let ref mut fresh44 = (*the_exception_context.as_mut_ptr())
                            .v
                            .etmp;
                        ::core::ptr::write_volatile(fresh44, err_msg);
                        longjmp(
                            (*(*the_exception_context.as_mut_ptr()).penv).as_mut_ptr(),
                            1 as libc::c_int,
                        );
    ...
    {} else {
        if !outfile.is_null() {
            fclose(outfile);
        }else { std::intrinsics::assume((outfile).addr() == 0); }
        if has_backup != 0 {
            if crate::src::osys::osys_rename(
                bakfile_name,
            ...
            if crate::src::osys::osys_unlink(outfile_name) != 0 as libc::c_int {
                opng_print_warning(
        ...
        loop {
            let ref mut fresh46 = (*the_exception_context.as_mut_ptr()).v.etmp;
    ...
    if options.preserve != 0 {
        crate::src::osys::osys_copy_attr(
            if new_outfile != 0 { infile_name_local } else { bakfile_name },
            outfile_name,
        );
    }
    if new_outfile == 0 && options.backup == 0 {
        if crate::src::osys::osys_unlink(bakfile_name) != 0 as libc::c_int {
            opng_print_warning(
...
pub unsafe extern "C" fn opng_initialize(
    ...
    memset(
        &raw mut summary as *mut opng_summary_struct as *mut libc::c_void,
        0 as libc::c_int,
        ::core::mem::size_of::<opng_summary_struct>() as libc::c_ulong,
    );
    engine.started = 1 as libc::c_int;
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn opng_optimize(
    ...
    if _setjmp(exception__env.as_mut_ptr()) == 0 as libc::c_int {
        loop {
            ...
            if process.status & INPUT_HAS_MULTIPLE_IMAGES as libc::c_int as libc::c_uint
                != 0
            {
                if options.snip != 0 {
            ...
            ::core::ptr::write_volatile(
                &raw mut result as *mut libc::c_int,
                0 as libc::c_int,
            );
            (*the_exception_context.as_mut_ptr()).caught = 0 as libc::c_int;
            if !((*the_exception_context.as_mut_ptr()).caught != 0) {
...
pub unsafe extern "C" fn opng_finalize() -> libc::c_int {
    if options.verbose != 0 || summary.snip_count > 0 as libc::c_int as libc::c_uint
        || summary.err_count > 0 as libc::c_int as libc::c_uint
    {
        usr_printf
            .expect(
                "non-null function pointer",
        ...
        if summary.snip_count > 0 as libc::c_int as libc::c_uint {
            usr_printf
                .expect(
                    "non-null function pointer",
                )(
        ...
        if summary.err_count > 0 as libc::c_int as libc::c_uint {
            usr_printf
                .expect(
                    "non-null function pointer",
                )(
            ...
            if summary.fix_count > 0 as libc::c_int as libc::c_uint {
                usr_printf
                    .expect(
                        "non-null function pointer",
                    )(
    ...
    engine.started = 0 as libc::c_int;
    return 0 as libc::c_int;
}
